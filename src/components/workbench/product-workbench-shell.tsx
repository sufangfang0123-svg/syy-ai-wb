  ...
  return <div className="product-workbench" data-product-workbench>
    <section className="project-command-bar" aria-label="当前项目状态">
      ...
      <dl className="project-command-facts">
        ...
        <div><dt>Evidence新鲜度</dt><dd>{evolutionState.versions.at(-1)?.fitness.freshness === "high" ? "演示夹具较新" : "需复核"}</dd></div>
        <div><dt>Gate</dt><dd>{gateLabel} · 固定演示</dd></div>
        <div><dt>最近保存</dt><dd>{state.lastSavedAt}</dd></div>
      </dl>
    </section>
    <div className="product-workbench-grid">
      <aside className="stage-rail" aria-label="爆品工作流阶段">
        <div className="stage-rail-title"><ClipboardList className="h-4 w-4" /><span>爆品工作流</span></div>
