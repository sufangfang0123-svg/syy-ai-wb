...
export type DataNature = "real_entry"|"manual_import"|"manual_hypothesis"|"fixed_demo"|"ai_proposal";
export type GovernedEntity = {id:string;project_id:string;status:string;revision:number;version:number;actor:string;data_nature:DataNature;is_stale:boolean;stale_reason:string;created_at:string;updated_at:string};
