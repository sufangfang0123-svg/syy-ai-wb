...
export default function ContentPage() {
  ...
  return <div className="page-frame">
    ...
    <div className="content-ownership" aria-label="内容责任分层"><span><b>事实层</b> 企业与真人证据确认</span><ArrowRight /><span><b>演示层</b> 内置夹具展示结构与渠道语气改写</span><ArrowRight /><span><b>发布层</b> 合规责任人批准后方可使用</span></div>
