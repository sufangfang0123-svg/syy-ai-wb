...
export const demoDecisionState: DecisionEngineState = {
  ...
  project: {
    ...
    investmentUnit: "人民币",
    industryPack: "棉生万物·棉品新品验证包",
    owner: "产品负责人（演示）",
    createdAt: "2026-08-08",
    isDemo: true,
  },
  evidence: [
    { id: "B018", title: "随行用品真人访谈", source: "7名目标用户访谈纪要", level: "B", observedAt: "2026-08-01", sample: "n=7，目标人群", finding: "5名受访者把单手取用列为关键体验。", scope: "短途差旅与通勤场景", limitation: "样本较小，尚未验证付费意愿。", projectId: "COT-DEMO-001", isDemo: true },
    ...
    { id: "D012", title: "79元价格压力测试", source: "合成情景测试", level: "D", observedAt: "2026-08-08", sample: "AI合成情景", finding: "价格接受度出现明显分化。", scope: "只用于寻找反例", limitation: "不是访谈、样品测试或真实购买。", projectId: "COT-DEMO-001", isDemo: true },
  ],
  assumptions: [
  ...
  tests: [
    { id: "NBT-COT-001", projectId: "COT-DEMO-001", assumptionId: "ASM-COST-01", hypothesis: "在相同内容物下，按日组合方案能获得足以支持便携溢价的真人选择。", primaryVariable: "包装组织方式：按日组合 vs 普通分装", baseline: "同内容物、普通透明分装袋、59元", controls: ["内容物数量一致", "视觉风格一致", "说明文案一致", "不展示品牌"], budget: 1200, duration: "3个工作日", sample: "24名目标用户的受控概念选择", passThreshold: "至少60%选择按日组合，且价格理由不是促销。", supplementThreshold: "40%—59%选择，需要补充价格或场景证据。", stopThreshold: "低于40%选择，暂停包装开模。", status: "recommended", evidenceLevel: "B", isDigital: false },
  ],
  decision: {
